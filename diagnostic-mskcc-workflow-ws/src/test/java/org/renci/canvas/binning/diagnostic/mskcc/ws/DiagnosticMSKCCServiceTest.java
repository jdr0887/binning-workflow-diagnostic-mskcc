package org.renci.canvas.binning.diagnostic.mskcc.ws;
...
public class DiagnosticMSKCCServiceTest {
    ...
    public void testSubmit() {
        ...
        String restServiceURL = String.format("http://%1$s:%2$d/cxf/%3$s/%3$sService", "localhost", 8181, "DiagnosticMSKCC");
