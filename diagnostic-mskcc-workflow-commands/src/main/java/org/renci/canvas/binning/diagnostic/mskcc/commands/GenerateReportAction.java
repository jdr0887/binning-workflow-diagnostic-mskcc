...
import org.renci.canvas.binning.diagnostic.mskcc.commons.GenerateReportCallable;
...
@Command(scope = "diagnostic-mskcc", name = "generate-report", description = "Generate Report")
@Service
