...
import org.renci.canvas.binning.diagnostic.mskcc.commons.UpdateDiagnosticBinsCallable;
...
@Command(scope = "diagnostic-mskcc", name = "update-diagnostic-bins", description = "Update Diagnostic Bins")
@Service
